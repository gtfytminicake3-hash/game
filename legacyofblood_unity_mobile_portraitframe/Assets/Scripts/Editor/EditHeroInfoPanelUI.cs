...
public class EditHeroInfoPanelUI
{
    [MenuItem("Tools/LegendOfBlood/Inject Frame And Banner")]
    public static void Run()
    {
        ...
        // Cần Instantiate prefab ra để sửa rồi save lại
        ...
        Image avatarImg = avatarProp.objectReferenceValue as Image;
        TextMeshProUGUI nameTxt = nameProp.objectReferenceValue as TextMeshProUGUI;
        ...
        if (nameTxt != null && bannerSprite != null)
        {
            ...
            Transform existingBanner = nameTxt.transform.Find("HeroNameBanner");
            if (existingBanner == null)
            {
                // Banner nên nằm SAU chữ (nghĩa là Parent của Name hoặc Child đầu tiên của Name nếu Name không có backgroud khác)
                // Hoặc đơn giản là tạo Banner làm sibling nằm TRƯỚC nameTxt
        ...
        Debug.Log("Prefab modifications saved.");
    }
}
