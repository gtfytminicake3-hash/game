...
[InitializeOnLoad]
public class ExtraHardRevertFontAuto
{
    static ExtraHardRevertFontAuto()
    {
        EditorApplication.delayCall += () => {
            ...
            if (countP > 0 || countS > 0)
                Debug.Log($"<color=green><b>[ÐÃ DÙNG PHÁP B?O V2]</b> T? d?ng ép {countP} Prefabs và {countS} Scene Objects v? Font '{defaultFont.name}'!</color>");
        };
    }
}
